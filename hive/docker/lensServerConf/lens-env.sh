...
#Classpath for lens server or client
export LENSCPPATH=`ls /usr/local/lens-internal/lib/mysql-connector-java-*.jar`:`ls /home/lens/extlib/vertica-jdbc*jar`:`ls $HADOOP_HOME/../hadoop-mapreduce/jets3t*.jar`:`ls $HADOOP_HOME/lib/hadoop-lzo*.jar`:`ls $HADOOP_HOME/lib/native/*.so 2>/dev/null | tr "\n" ':' 2>/dev/null`
